...
export default class RestaurantFilterSection extends Component<{}>
{
        ...
        return (
            <View style={[styles.container, this.props.customStyle]}>
                <View style={styles.viewWrapper}>
                    ...
                    <View style={[styles.viewWrapper, {position:'absolute', right: 47}]}>
                        <StarRating
                            disabled={false}
                            maxStars={5}
...
RestaurantFilterSection.defaultProps = {
    customStyle: {
